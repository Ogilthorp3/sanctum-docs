...
![HERO PENDING — see drafts/README-hero.md](./images/hero-archive-that-said-nothing.png)

Jocasta Nu, Chief Librarian of the Jedi Archives, is remembered for one line: *"If an item does not appear in our records, it does not exist."* She says it to Obi-Wan while standing in front of a shelf with a planet deliberately erased from it. The line is not a boast about the archive. It is the moment the archive fails, delivered in the voice of total confidence.
