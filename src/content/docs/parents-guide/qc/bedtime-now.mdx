...
Il est 22 h 05. L'argument du couvre-feu est perdu — ou techniquement gagné, juste pas respecté. Ton pouce est déjà au-dessus du téléphone. **Dodo maintenant**, c'est le bouton pour ce moment-là exact : y finit la soirée drette-là au lieu d'attendre que l'horaire se décide.

Le crépuscule dans cabane a déjà un gardien : [Tommy](/agents/tommy/) fait sa ronde à c't'heure-là depuis quinze ans. Le bouton, lui, s'occupe juste des écrans.
...
Ça coupe toute d'un coup, jusqu'au réveil. Si tu veux juste une pause temporaire — mettre les écrans su'pause pour un boutte, pas finir la soirée au complet — c'est [Bloque ça drette-là](/parents-guide/qc/block-now/) que tu veux, pas ce bouton-icitte.
...
<Aside type="note">
Si une carte reste non confirmée deux-trois secondes après ta tape, l'app attend juste la boîte réseau avant de crier victoire. Une carte qui reste rouge nomme l'appareil qui a pas suivi — la page [Troubleshooting](/parents-guide/troubleshooting/) du guide couvre la suite.
</Aside>
...
Si queque chose peut vraiment pas attendre — un fichier de devoirs resté dans le cloud, un appel obligé — un override peut percer un trou temporaire dans la pause. Ça vit su'a page [More Time](/parents-guide/more-time/) pis c'est cappé à 120 minutes, faque l'exception d'à soir peut pas devenir tranquillement la règle de demain.

Le bouton s'occupe des écrans. Le reste de la nuit, c'est Tommy qui la veille — le chat de la cabane qui a vu c't'heure-là passer ben avant qu'y'ait des écrans à éteindre. Le verre d'eau, le deuxième verre d'eau, pis l'intérêt soudain pour la philosophie à l'heure du dodo, eux autres, restent hors scope. Ça, c'est de son ressort à lui.
