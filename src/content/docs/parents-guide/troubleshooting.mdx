...
- **"The budget never blocked anything."** Budgets are per-child across all devices, metered at the network by category — and they run in shadow (log-only) mode until you arm them. A budget you have not armed will observe forever and block nothing. That is the design, not a fault.
- **"More time ended too soon."** Overrides cap at 120 minutes. The timer did not cheat; it hit the ceiling.
- **"It is blocked and I never chose an end."** You did — a pause always requires a who and a duration, and the longest duration is *jusqu'au réveil*. The end you chose is on the badge.
