...
![Windu — the security agent who treats every packet like a potential threat and every open port like a personal insult](../../../assets/illustrations/windu-security-perimeter.png)
...
<Aside type="note">
Windu generates a security briefing every morning. It covers new devices on the network, unusual traffic patterns, blocked threats, and any policy violations detected overnight. The briefing is thorough. Some might say exhaustive. Windu would say those people don't take security seriously enough.
</Aside>
