...
![Jocasta in the archive — she already knows why you're here](../../../assets/illustrations/jocasta-archive-library.svg)
...
Through the `apple-toolkit` skill, Jocasta has direct access to four messaging channels:

<CardGrid>
  <Card title="iMessage" icon="apple">
    Native macOS Messages integration. Read and send from any synced conversation.
  </Card>
  <Card title="WhatsApp" icon="phone">
    Via WhatsApp Web bridge on the Mac. Group and individual messaging.
  </Card>
  <Card title="Signal" icon="star">
    Local Signal database access. The most private channel, handled accordingly.
  </Card>
  <Card title="Slack" icon="comment">
    Workspace messaging for professional contexts.
  </Card>
</CardGrid>
...
```
Jocasta (Mac:18789) ──SSH──> Yoda (VM:OpenClaw)
Yoda    (VM)         ──SSH──> Jocasta (Mac:18789)
```
...
| Gateway port | 18789 |
| Model tier | `council-brain` (Qwen 3.5 Plus, claude-opus-4-6 fallback) |
