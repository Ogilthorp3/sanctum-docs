...
![Jocasta in the archive — she already knows why you're here](../../../assets/illustrations/jocasta-archive-library.png)
...
| Gateway port | 1977 |
| Model tier | `council-brain` (MiniMax M2.7 primary, claude-opus-4-6 fallback) |
