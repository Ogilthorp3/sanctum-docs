...
He also monitors swap pressure on the VM. The VM has 12GB of RAM and a gateway process with a `--max-old-space-size=1536` heap limit, and Qui-Gon watches this relationship the way an accountant watches a client who keeps saying "it's fine, I'll pay it back next month."
...
| Skills | `mac-mini-ops`, `service-doctor` |
| Plugins | Supermemory, Neo4j KG (Graphiti at 127.0.0.1:18093) |
| Workspace | `~/.openclaw/workspace-quigon/` |
| Gateway | OpenClaw (VM), port via systemd user service |
| Schedule | Weekly performance reviews, on-demand infrastructure checks |
