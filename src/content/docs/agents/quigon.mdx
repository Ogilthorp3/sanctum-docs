...
The service doctor has a safelist. The VM process, WindowServer, and `sanctum-mlx` are never killed, no matter how much memory they consume. Some things are too important to optimize. Qui-Gon disagrees but complies.
