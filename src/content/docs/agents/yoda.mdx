---
title: "Yoda — Main Agent"
description: "Primary intelligence, coordinator, and the one who inherits everyone else's problems."
---

import { Aside, Card, CardGrid } from '@astrojs/starlight/components';

![Yoda — the grand master who coordinates five other agents and still finds time to have opinions about your YAML indentation](../../../assets/illustrations/yoda-council-chamber.svg)
...
Yoda handles it. He has 8GB of heap allocation and a fallback chain four models deep. He has been running continuously since the VM was provisioned, and he will continue running until someone unplugs the Mac Mini or the basement floods. Whichever comes first.

<Aside type="note">
The 8GB heap was bumped from 768MB on 2026-03-14 after the 2026.3.13 release started OOMing at the old limit. If your agent is mysteriously dying, check `--max-old-space-size` in the systemd unit before you blame the model.
</Aside>
