...
![Yoda — the grand master who coordinates five other agents and still finds time to have opinions about your YAML indentation](../../../assets/illustrations/yoda-council-chamber.png)
...
| Fallback chain | Claude Opus 4.6 → Claude 3.5 Sonnet → DeepSeek V3.2 → MiniMax M2.7 |
