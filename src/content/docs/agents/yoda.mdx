...
| Fallback chain | Claude Opus 4.7 → MiniMax M2.7 → Qwen 3.5 Plus → Council 27B |
...
|-------------|-------|-----------|
| Code / tool sessions | Claude Opus 4.7 | Quality matters when you're writing infrastructure |
| Security queries | Claude Opus 4.7 | Windu would never forgive a downgrade |
