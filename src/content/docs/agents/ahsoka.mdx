...
<Aside type="caution">
  This page documents a system that has not been deployed. Everything below describes intended behavior. If you are reading this from the chalet Mac Mini, congratulations -- you made the drive. Now run the install scripts.
</Aside>
...
<Aside type="tip">
  The chalet is in the Laurentians. In February, "weather monitoring" is a polite way of saying "pipe burst early warning system." Ahsoka's most important job may be the one that sounds the least impressive.
</Aside>
...
| Resource | Hub (Manoir) | Satellite (Chalet) |
|----------|-------------|-------------------|
| Chip | M4 Pro | M1 |
| Memory | 64 GB | 16 GB |
