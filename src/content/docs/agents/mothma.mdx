...
![Mon Mothma surveying the operations command center — holographic dashboards aglow, everything under control](../../../assets/illustrations/mothma-operations-center.png)
...
mothma:
  ...
  model:
    ...
    fallbacks:
      ...
      - council-local/Qwen3.5-27B-4bit-text
  heartbeat:
    every: 10m
