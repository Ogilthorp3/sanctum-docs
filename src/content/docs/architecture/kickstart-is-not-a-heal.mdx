...
remediation:
  actions:
    - name: kickstart-system-daemon
      cmd: ~/.sanctum/scripts/heal_system_daemon.sh com.sanctum.force-flow http://127.0.0.1:4077/health
  restart_cmd: ~/.sanctum/scripts/heal_system_daemon.sh com.sanctum.force-flow http://127.0.0.1:4077/health
```
