...
![A vintage telephone switchboard operator routing alerts through a failover queue of pneumatic tubes — one tube glows teal as it carries a critical message past a dissolving signal-cli daemon](./images/hero-msg-bus.png)
