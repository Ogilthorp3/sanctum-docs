...
A 64 GB Mac Mini hosts the Temple's kyber — Cilghal, the 35-billion-parameter MoE, 21 GB resident at idle and 41 GB at peak under a full 32K-token context. It also hosts an on-call code seat — Devstral Small 2 24B, 13 GB when she's serving and effectively zero when she's idle. Plus a Lima VM and the apps the operator actually uses. The arithmetic doesn't work unless somebody keeps watch.
