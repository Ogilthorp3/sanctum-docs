...
| `cloud` | Claude Opus (Max subscription — the unpinned `claude-opus-4` alias serves the latest Opus, 4.8 today) via `claude-max-api-proxy` on `:3456` (runs on the MBP) | opus, claude-\*, escalation | Max OAuth (proxy-mediated) |
