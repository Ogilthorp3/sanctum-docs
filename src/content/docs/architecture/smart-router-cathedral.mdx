...
coder:
  ...
  default_model: Codestral-22B-v0.1-4bit
cloud:
...
| `coder` | Codestral-22B-v0.1-4bit via `sanctum-mlx-codestral` on `:3301` (native MLX seat) | coder, code-\*, \*coder\*, ahsoka | loopback |
| `cloud` | Claude Opus 4.7 via `claude-max-api-proxy` on `100.0.0.55:3456` (Mobile primary) with `100.0.0.20:3456` (Hub secondary, since 2026-04-27) | opus, claude-\*, escalation | Max OAuth (proxy-mediated, separate session per host) |
