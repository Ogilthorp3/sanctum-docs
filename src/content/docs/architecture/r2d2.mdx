...
<Aside type="note">
Eleven layers between a detection and a deletion. Any single false-positive costs at most a renamed file — reversible. The cost of *not* firing, multiplied across days of stale binaries, drifted Keychain entries, and orphan LaunchAgents, is the slow accumulation that broke unattended operation for years before this drone existed.
</Aside>
...
- Design: `sanctum-config/docs/specs/2026-06-05-r2d2-vault-pstar-design.md` (council-blessed, 5 lenses, unanimous SHIP-WITH-FIXES, approach A-then-B)
