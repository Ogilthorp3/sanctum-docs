...
| `com.mundi.briefing` | `mundi-watch.py` (sanctum-crm) | every 30 min, 07:00-22:00 | intel, event-driven | Fires only on a deal-related email or a due Affinity reminder; inline action brief + :2600 dossier |
