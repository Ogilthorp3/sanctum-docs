...
The cathedral fork serves `:1337` and `:1338` over **mTLS-only** in production. Every eval pointed at `https://100.0.0.25:1337/v1` (or `manoir.tail7c6d11.ts.net`) must present a client cert signed by the Sanctum CA.
