...
| 3456 | Claude Max Relay | Mac | Sequel to Password1 | 1234 is Password1 (above). 3456 is what you pick when someone says 1234 is too weak and you "fix" it by sliding two keys to the right. Tailscale-only, so the laziness stays contained. Relays Claude Max to in-haus agents across the tailnet. |
