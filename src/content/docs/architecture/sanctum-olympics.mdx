...
cd sanctum-olympics
python run_olympics.py --backend council-mlx --category reasoning
...
|----------|-------------|-------|
| Code Generation | Codestral-22B (`sanctum-mlx-codestral` `:3301`) — succeeded the retired Qwen2.5-Coder seat (`sanctum-mlx-coder` `:1338`, retired 2026-06-07) | — |
| Council Identity | Council MLX (V3 LoRA) | 0.752 |
| Reasoning | Council MLX | 1.000 |
