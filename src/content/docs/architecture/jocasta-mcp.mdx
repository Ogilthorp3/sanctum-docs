...
- **`jocasta_send_imessage`**: hands the message to the Messages daemon to send as iMessage/SMS.
  - *Primary use case*: Mon Mothma runs this as a pager. When a service drops, she texts the alert to your own phone — the one channel that lights up the lock screen whether or not you're at the terminal.
