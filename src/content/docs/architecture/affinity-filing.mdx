...
| Job | When | Writes |
|---|---|---|
| `com.work.file-mail` | every 2 hours (Aqua) | `file-mail --all` then `file-notes --all` |
| `com.work.weekly-brief` | Friday 16:07 | `reminders --execute`, then a read-only digest |
...
launchctl print gui/$(id -u)/com.work.file-mail
```
