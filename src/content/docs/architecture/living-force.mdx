...
- **2026-04-21 — [Three More Clients on mTLS](/operations/2026-04-21-mtls-migration/)** — bearer retirement advances; five of six probe clients now present client certs, the sanctum-server router is the last holdout.
