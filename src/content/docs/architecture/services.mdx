...
|---------|------|----------|-------------|-------------|
| LM Studio | 1234 | — | `com.sanctum.lmstudio-bridge` | Local LLM inference for VM agents. Currently serving `qwen3.6-35b-a3b` (the council heartbeat / general local tier) via socat bridge from `10.10.10.1:1234` to `127.0.0.1:1234`. API key: `lm-studio`. The `qwen2.5-coder-14b-instruct` it used to serve was retired 2026-05-10. |
