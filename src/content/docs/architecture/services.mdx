...
| Service | Port | Codename | LaunchAgent | Description |
|---------|------|----------|-------------|-------------|
| SanctumBridge | `1455` | Gutenberg — the first bridge between knowledge and the people | — | Read-only HTTP proxy to FDA-protected SQLite databases (iMessage, WhatsApp, Contacts, Calendar). Jocasta-mcp queries through it so the MCP server itself doesn't need Full Disk Access. |
