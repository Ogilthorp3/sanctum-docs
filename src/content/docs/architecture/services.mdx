...
| Council-27B MLX | `1337` | leet — the coding brain | `com.sanctum.idle-mlx` | **sanctum-mlx v0.2.0** — Pure Rust inference server. Qwen 3.5 27B 4-bit via mlx-rs bindings on Metal GPU. Fused GatedDeltaNet kernel, zero-copy GQA, ~13 tok/s decode. Zero Python. KeepAlive enabled. |
