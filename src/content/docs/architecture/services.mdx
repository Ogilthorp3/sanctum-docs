...
Twenty ports. Two hosts. One network that exists entirely inside a closet. Print this table out. Tape it to the wall next to the Mac Mini. You will need it at 2 AM when something is listening on a port you don't recognize and you're debugging five different systems in your underwear.
