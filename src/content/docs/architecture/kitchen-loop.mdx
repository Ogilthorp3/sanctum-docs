...
![Tommy supervises the Kitchen Loop — six stations, one conveyor belt, zero regressions](../../../assets/illustrations/kitchen-loop-conveyor.png)
...
Reading it felt like finding the blueprint for the thing we'd been building by hand. Not because Sanctum already does this — it doesn't, not fully — but because every piece of the framework maps to something the Living Force already attempted, half-built, or wished it had. This page documents how those pieces fit together, what we gain, and what changes.
