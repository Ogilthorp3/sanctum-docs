...
![A pencil sketch of a lighthouse on a rocky shore at dusk, beam sweeping across an empty sea — the keeper invisible inside, the light the only proof anyone is home.](./images/hero-reliability-doctrine.png)
