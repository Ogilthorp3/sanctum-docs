---
title: Force Flow
description: The unified notification hub. One service, one brain, every alert in the house flows through it.
---

import { Aside } from '@astrojs/starlight/components';

Every notification in the house used to go through three different systems. Home Assistant had its own push notifications. The Living Force had `sanctum_notify`. The Council Router had its escalation chain. Three notification stacks, four channels, zero coordination — which is how you end up with Yoda's cloned voice shouting about Ring motion through the bathroom speaker at 7 AM while your phone buzzes twice about the same squirrel.
...
<Aside type="note">
The database keeps everything. There is no automatic purge. If this becomes a problem in three years, the problem will be that the house has sent too many notifications, which is itself a notification worth investigating.
</Aside>
...
As of March 30, 2026, the migration is complete. Every notification source in the house routes through Force Flow:
