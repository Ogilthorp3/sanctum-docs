...
|------|------|----------|--------|------|
| `hub` (MM64) | `10.10.10.1` | `bert` | jocasta, codex, claude, gemini | Mac Mini — intelligence, CRM, the bridge between the haus and the world |
| `vm` (Manoir VM) | `10.10.10.10` | `ubuntu` | yoda, windu, quigon, cilghal, mundi | QEMU VM — the Council proper |
| `satellite` (MM16) | `100.0.0.32` | `bert` | ahsoka | Chalet Mac — remote presence, eventually home automation |
| `mobile` (MBP128) | `10.0.5.2` | `bert` | gemini, claude | MacBook Pro, when docked on Thunderbolt |
...
| Smart-routed | `council-brain` on `:4040` | Yoda — Opus by default, local council-27b for general chat, `council-max-thinking` for deep reasoning |
