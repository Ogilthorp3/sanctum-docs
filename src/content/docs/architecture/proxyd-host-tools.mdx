...
![Velvet rope and clipboard at the Max/Fable host-tools doors — PascalCase tools pass, foreign harness tickets stay out](./images/hero-proxyd-host-tools.png)
...
If the bouncer is wrong, you fix the shape rule — not the seat. If the bouncer is right, you stop blaming Max for a tool that was never allowed through the rope.
