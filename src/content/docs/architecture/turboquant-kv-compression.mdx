...
| Flag | Env | Effect |
|------|-----|--------|
| `--metal-cache-limit-mb` | `SANCTUM_MLX_CACHE_LIMIT_MB` | Cap MLX's reusable buffer cache. Stops `sanctum-mlx` from fighting `sanctum-mlx-coder` for the Metal heap. |
