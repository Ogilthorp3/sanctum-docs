...
<CardGrid>
  <Card title="Hub" icon="rocket">
    The full-stack primary node. Runs the Mac Mini host with the Ubuntu VM, all AI agents, the Home Assistant gateway, inference servers, and the complete service catalog. There is exactly one hub per Sanctum instance.
  </Card>
