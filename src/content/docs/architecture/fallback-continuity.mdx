...
None of this changes the promise, which was always the small one: hand the turn to the next runner without dropping the baton. Tommy, who spent fifteen years watching this haus and never once lost the thread of a morning, would call that the bare minimum. He would be right. A relay is only ever as good as the exchange, and the exchange is finally clean.
