...
| Coder Plain Bridge | Host | 1234 | `127.0.0.1` | `socat` plain HTTP → `sanctum-mlx-coder` mTLS `:1338`. Was LM Studio pre-2026-05-11. |
...
| Coder MLX (`sanctum-mlx-coder`) | Host | 1338 (mTLS) | `127.0.0.1` + Tailscale | Qwen2.5-Coder-14B; same pure-Rust binary family as `sanctum-mlx` |
...
services:
  openclaw-core:
    ...
    environment:
      ...
      - CODER_BRIDGE_PORT=1234   # socat → sanctum-mlx-coder mTLS :1338
