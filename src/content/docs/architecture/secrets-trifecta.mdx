...
Neither phase is urgent. The trifecta as built moves toward the bar set on 2026-04-29: the user does not have to remember it exists. The doctrine, the manifest, and the recovery story already clear it; the unattended daemon is the last mile. That is the only test that matters, and it is the one still being earned.
