...
|--------|----------|-------------|
| `chores` | 30 min | Household tasks verified by parent |
...
New devices on the network are auto-discovered via ARP scanning and classified by OUI (manufacturer) lookup. Unknown devices get house rules applied immediately. Parents approve or remove guests via the PWA. Guest permissions expire after 24 hours.
