...
router:
  backends:
    ...
    coder:
      ...
      description: "Codestral-22B-v0.1-4bit - pure code + Qui-Gon + Ahsoka (chalet 16 GB)"
    cloud:
...
| **Ahsoka** | coder — Codestral-22B-v0.1-4bit (chalet `sanctum-mlx-codestral`) | — | Runs on a Mac Mini M1 16 GB at the chalet; 35B won't fit |
