...
|---|---|---|---|
| **Bert** (`me`) | Operator / GP | Visionary, direct, bilingual (Joual/FR + Silicon Valley EN), punchy, low-friction | 104,956 interactions (18k mail, 80k imsg, 4.8k signal) |
| **Andréanne** (`wife`) | Academic Researcher | Thoughtful, articulate, organized, warm, logistical coordination | 6,574 interactions (1.8k mail, 4.6k imsg) |
| **Albert** (`kid`) | Student / Gamer | Casual youth Quebec French texting, ultra-concise, playful requests | 344 interactions (337 imsg, 5 mail) |
...
sanctum-crm twin show bert
sanctum-crm twin collage bert --channel email --limit 5

# Draft an authentic email or message
sanctum-crm draft --persona bert --to "Charles" "Let's review the Series A term sheet tomorrow at 10am"
...
sanctum-crm draft --persona bert --to "charles@triptyq.vc" --open "Follow up on term sheet milestone"
```
...
- Bert's digital twin is dynamically restricted to work-graph communications (`@triptyq.vc`), with all family iMessages, Signal chats, and personal threads omitted from the collage.
