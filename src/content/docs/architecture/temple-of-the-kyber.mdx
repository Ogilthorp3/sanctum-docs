...
Five Jedi, one bench, three model families. Each owns a domain. Each routes to the saber best-suited to it. Each falls back to the Temple's kyber if their primary backend goes quiet. Each emits a briefing on a schedule, and as of the [Vision Probe Lied](/operations/2026-05-10-the-vision-probe-lied/) sweep, every briefing is silent on green and alert-only on red.
