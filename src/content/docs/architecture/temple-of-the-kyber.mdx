...
Three rules carry the rest — and a fourth, named after a cat, decides the ties:
...
A fourth, quieter rule needs no closing line to enforce it. If Tommy — the haus's late, much-missed cat — wouldn't approve of the page, the deploy, or the doctrine, rewrite it. He never weighed in on a single one. He didn't have to. (For a while he was *quoted* at the end of a third of the chapters in this book, which is precisely the sort of over-explaining he would have found undignified. The standard survived the edit. The wallpaper did not.)
</Aside>
