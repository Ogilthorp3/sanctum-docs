...
[ Mac Mini M4 Pro ]  ----bridge100 (10.10.10.1)----  [ Ubuntu 24.04 VM ]
  |                                                     |
  +-- DenchClaw Gateway    :19001                       +-- OpenClaw Gateway  :18789
...
Stare at that diagram long enough and two things become clear: first, this is a real system that actually runs a household. Second, no one should have let it get this far. And yet here we are, port 18094 deep, with no intention of stopping.
