...
<CardGrid>
  <Card title="DenchClaw Gateway" icon="rocket">
    The Mac-side agent gateway. Runs Jocasta, the household management agent. Exposes port 1977 for local clients and the Holocron chat interface on port 1977.
  </Card>
...
The VM runs OpenClaw with five specialized agents, each with a distinct role. Yes, someone named their haus automation agents after Star Wars characters. No, there was never a serious alternative under consideration.
