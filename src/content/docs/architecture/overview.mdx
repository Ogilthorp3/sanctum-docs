...
|-------|------|------------|
| **Yoda** | [Consigliere](/agents/yoda/) — absorbs everyone else's escalations, advises the Don | `council-brain` — Opus 4.7 by default; smart-routed to local `council-27b` for general chat and Opus 4.7 `--effort max` (Claude Team) for deep reasoning |
