...
description: How to install Sanctum on a Mac for your household — the hash-pinned 2-step pattern.
---
...
- A free [Cloudflare account](https://dash.cloudflare.com/sign-up) for the R2 backup target (10 GB free tier covers most households)
