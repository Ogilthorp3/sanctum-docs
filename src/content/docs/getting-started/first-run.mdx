...
![A freshly powered Mac Mini glowing amber for the first time, a wordless row of health-check dots lighting up above it while an Abyssinian cat watches — the first heartbeat of a new Sanctum instance](./images/hero-first-run.png)
