...
1. **Check the bridge interface.**
   ...
   You should see the Mac-side bridge address (`10.0.0.1` in the default config) assigned to the interface. If the interface does not exist, verify that QEMU is running and the VM is started.
