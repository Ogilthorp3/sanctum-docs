...
<Aside type="tip">
The thing that took the longest to build was making sure thirty minutes is actually enough — we kept finding the half-hour was really forty-five. If something in the quick path stalls past the budget, that's a real bug, not your tea going cold; please report it.
</Aside>
