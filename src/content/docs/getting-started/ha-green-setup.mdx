...
description: "Connect the Home Assistant Green — the haus's home-automation hands for lights, climate, Sonos, and screen-time. A sealed appliance, token-only, with tailnet-private remote access."
---

import { Aside, Steps } from '@astrojs/starlight/components';

![A pencil sketch on a dark background: a small green home-automation appliance glowing on a shelf, faint lines reaching out to a lamp, a thermostat, and a speaker, a wise cat keeping watch from the corner, one warm amber accent on the appliance's status light](./images/hero-ha-green-setup.png)
