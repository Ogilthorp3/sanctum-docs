...
Sanctum is the platform that fires you from that job. One Mac Mini in your closet, one config file, one dashboard — haus automation, AI agents, network management, and local voice control, all answering to your hardware and no one's cloud. It is built for the kind of haus where "reboot the router" is not a punchline but a Tuesday.
