...
If you plan to run VM workloads (agent orchestration, knowledge graph), set up the Ubuntu VM. This is where the system goes from "neat home automation project" to "wait, you're running a knowledge graph in a virtual machine inside a Mac Mini?"
