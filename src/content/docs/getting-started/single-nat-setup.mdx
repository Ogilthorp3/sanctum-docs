...
3. **Reverse it any time.**
   ...
   Disables the DMZ, re-leases DHCP, and lands you back on verified-online double-NAT in one command. The armor hook and sentinel stay installed but go inert — on a normal private lease they are a safe no-op.
