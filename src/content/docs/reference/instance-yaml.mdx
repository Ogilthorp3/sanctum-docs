...
![One YAML to rule them all — a single configuration file radiating control to every service in the constellation](../../../assets/illustrations/instance-yaml-radiate.png)
