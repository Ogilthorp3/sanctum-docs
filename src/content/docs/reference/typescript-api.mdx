...
<Aside type="tip">
The `|| 1111` fallback means the dashboard will start even if the config is missing the dev port. Defensive coding for a config file that controls your house. Belt, suspenders, and a third thing holding up your pants that hasn't been invented yet.
</Aside>
