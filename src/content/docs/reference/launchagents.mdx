...
![The template forge — where XML plists are stamped into existence with the precision of a bureaucracy that runs on cron](../../../assets/illustrations/launchagents-assembly.png)
