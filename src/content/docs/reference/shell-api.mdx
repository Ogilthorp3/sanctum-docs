...
These functions query the `nodes` section of the instance config. They accept a `<node_id>` argument (e.g., `manoir`, `chalet`). Useful when your home automation hobby has metastasized into a multi-site distributed system.
