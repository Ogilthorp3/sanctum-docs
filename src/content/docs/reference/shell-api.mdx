...
![The function tree — every shell helper branching from a single source into the operations that keep the lights on](../../../assets/illustrations/shell-api-tree.png)
