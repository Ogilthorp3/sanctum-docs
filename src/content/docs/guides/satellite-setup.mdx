...
On the satellite Mac, set hostname, enable SSH and Screen Sharing, and install Tailscale from the App Store. Screen Sharing is non-negotiable — you will need to reach this machine remotely, and "drive four hours to the chalet to restart a LaunchAgent" is not an acceptable runbook.
