...
Sanctum manages 10 Sonos speakers across the house. The speakers are **not** controlled through HA's built-in Sonos integration. That integration is disabled. Instead, a native Python service called the Sonos Bridge runs directly on the Mac Mini, bypassing Docker entirely.
