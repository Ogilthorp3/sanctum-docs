...
The bridge generates speech using the Qwen3-TTS server on port 8008 (mlx-audio backend; XTTS-v2 retired 2026-04-19), saves the WAV file locally, and tells Sonos to fetch it from `http://<mac-lan-ip>:18421/<id>.wav`. The voice is Yoda. There was a discussion about this. Yoda won.
