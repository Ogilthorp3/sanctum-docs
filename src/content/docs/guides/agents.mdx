...
|------|--------------|----------------|--------|
| `council-brain` | Claude Opus 4.7 | minimax-m27 → qwen35-plus → council-code → council-27b | Yoda, Jocasta |
...
| `council-heartbeat` | Council 27B (local) | council-27b → minimax-m25-free | All (heartbeat/status) |
...
- `1337` is the Sanctum-served Council 27B front-end.
