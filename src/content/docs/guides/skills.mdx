...
The council gets smarter on a schedule. [Tommy](/agents/tommy/), who has no tools and wants none, remains serenely unimproved — he files the same weather report he has filed for fifteen years and considers the matter closed. He is the one exception. Everyone else is always one hourly pull away from a new trick.
