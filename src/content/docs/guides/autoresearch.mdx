...
The LaunchAgent fires at 2:00 AM, runs up to 6 experiments over 3 hours, and quietly goes back to sleep. The council-mlx server is always restored before morning traffic.
