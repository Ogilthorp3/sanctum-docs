...
<Aside type="note">
  The biggest lesson from this project: **data quality > hyperparameter tuning**. The v2 adapter failed not because the gradients were wrong but because 63% of the synthetic data was near-duplicate — the model memorized instead of learning. Fix your inputs before you optimize your gradients.
</Aside>
