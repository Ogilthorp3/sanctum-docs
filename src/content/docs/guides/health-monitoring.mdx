...
![The health dashboard — your haus gets more checkups than you do, and it doesn't even complain about the copay](../../../assets/illustrations/health-monitoring-dashboard.svg)
