...
health:
  ...
  liveness:
    ...
    interval: 60
remediation:
  restart_command: "launchctl kickstart -k gui/$(id -u)/com.sanctum.litellm-proxy"
  max_restarts: 3
  quarantine_after: 3
```
