...
Run `sanctum net check` first, believe the reasoning line over the verdict, and stay off `optimize` until the pane tells you to reach for it. Most nights, that is the whole job: the haus was online the entire time, the fibre was carrying every bit it promised, and the only thing that needed fixing was the tool doing the accusing. Qui-Gon, who watches the infra, will tell you the same thing in fewer words. He would just close the terminal.
