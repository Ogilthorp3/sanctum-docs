...
<Aside type="tip">
  **Mem0 is the primary memory layer.** It's free, supports structured filtering (by user, agent, project, metadata), and is wired into Rube where all automations live. Project: `sanctum-memory`, user: `Ogilthorp3`. Every recipe that needs context about the house queries Mem0 first.
</Aside>
