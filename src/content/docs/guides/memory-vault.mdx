...
![The memory vault — where knowledge goes to be preserved, indexed, and occasionally forgotten on purpose](../../../assets/illustrations/memory-vault-door.svg)
...
<Aside type="tip">
  Opening the memory directory in Obsidian gives you a graph view of your house's knowledge. The wikilinks render as connections. It's beautiful, informative, and a little like reading someone's diary — except the someone is your haus infrastructure.
</Aside>
