...
The Council got a brain transplant one evening in April, and a month later we put the old brain back. In between, Gemma 4 trained twice as fast on half the memory. It held the seat for a week. Then a benchmark changed its mind, and the model we already trusted won the rematch. What survived the round trip was not the model — it was one lesson about the data, and that lesson is the reason this page is worth keeping.
