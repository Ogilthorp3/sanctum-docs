...
The request was simple: *"give me the full haus security status, and fix what's weak."* What
followed was a lesson the haus keeps teaching — the most dangerous move in security work isn't
missing a threat, it's **fortifying the wrong thing with confidence**. Nearly every fix this day
began as a plausible, wrong conclusion, and the only thing between it and a shipped mistake was the
habit of checking first.
...
classical crypto. Deploying isn't the milestone; verifying where it counts is.
...
control, driven by Home Assistant over the LAN. Firewalla's flat-network isolation is a bidirectional
