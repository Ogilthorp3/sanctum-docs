...
This means a compromised VM can't phone home, can't exfiltrate data, can't join a botnet. The worst it can do is send a strongly worded message to the Mac, which is already watching.
