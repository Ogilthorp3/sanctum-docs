...
5. **Auto-login enabled** — macOS boots straight to the desktop, LaunchAgents start, services recover. No human in the loop.
...
The Mac boots to auto-login, LaunchAgents fire, post-boot runs health checks, and the council reconvenes. No password required. No drive to the house. No calling your neighbor.
