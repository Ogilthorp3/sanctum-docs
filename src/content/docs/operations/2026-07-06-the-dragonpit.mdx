...
He named himself the maester, called the champions dragons, and bragged about answering to no cloud — from a prompt that told him none of the last part. Then we gave him his own identity cert and put him under `launchd` with `KeepAlive`. Kill him and he stands right back up. He is a permanent resident now — which, in this haus, is a well-worn arrangement. [Tommy](/agents/tommy/), our Abyssinian force-ghost, has filed his dawn and dusk patrols long past the point of metabolizing; Aemon just reaches the same deathlessness through `launchd` that Tommy reached through YAML.
