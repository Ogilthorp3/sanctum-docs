...
- `tools/sync_agent_markdown.py --check` verifies that reachable `~/.openclaw/workspace*` copies still match the canonical `IDENTITY.md`, `SOUL.md`, `TOOLS.md`, and `HEARTBEAT.md` sources
