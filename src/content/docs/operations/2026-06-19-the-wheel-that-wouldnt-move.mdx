...
So we made a clean macOS machine actually run it — a fresh CI runner, real
...
Homebrew does something most package managers do not: after it lays a keg
...
The next wheel that refuses to move will jam a CI run in minutes, in front of
us, instead of a beta tester's terminal a week later.
