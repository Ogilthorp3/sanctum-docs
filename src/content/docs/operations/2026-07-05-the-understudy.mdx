...
Rollback for the whole trial is one restored plist and one bootstrap. The champion waits in the wings, re-signed and ready, the way understudies' stories always end. Tommy watches from the balcony, one paw raised, withholding judgment until the numbers earn it. Unless this one doesn't.
