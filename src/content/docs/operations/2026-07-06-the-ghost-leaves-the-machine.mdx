...
Last night's field note ended with a promise: *porting the roll-call to the
mTLS Temple seats is sanctum-rs work for another night.* This was that
night. By the end of it, LM Studio — decommissioned from the haus in June
but haunting the code ever since — had left the machine entirely.

## The port

The watchdog's Living Force roll-call was the last living consumer of the
...
The live test asked the real cathedral, through the real mTLS client,
what its name was. It said *Yoda*.

## The purge

The port unblocked the sweep. Twelve source files and two whole modules
...
Redeploying `sanctum-triage` — rebuilt only to drop its dead
