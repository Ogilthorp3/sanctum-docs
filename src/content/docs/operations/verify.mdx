...
![Verify — an inspector's bench laid out with a stethoscope, tuning fork, balance scale, and probe, all aimed at a small glass model of the Sanctum building; vibes are not permitted in the building.](./images/hero-verify-operator-guide.png)
