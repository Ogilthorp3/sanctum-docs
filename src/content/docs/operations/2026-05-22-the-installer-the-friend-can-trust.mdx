...
description: "The test for whether Sanctum is ready for a friend is the 9pm 'it broke' DM — what do they type back? Eight commits and tag v0.9.0 later, the funnel lands in a verified green panel, the verify path is cryptographic, the trust gates let the friend walk away with their keys, and the bug-report form refuses credentials by design. The friend can try it."
---

import { Aside } from '@astrojs/starlight/components';

![A pencil sketch of a curl pipe leading from an open laptop into a small wooden box labeled "Sanctum"; Tommy the guardian cat watches from beside the box, paw resting on a wax-sealed envelope marked SHA-256](./images/2026-05-22-the-installer-the-friend-can-trust.png)
