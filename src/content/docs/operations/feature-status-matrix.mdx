...
|---------|--------|-------------------|
| Service Graph | `implemented` | `service-graph.py` exists, runtime manifests render into `~/.sanctum/services`, and the checked-in audits prove graph edges such as `xtts-server -> voice-agent` (Q2 rename). |
