...
| Immune System | `partial` | The Rust watchdog, anomaly detector, and remediation budget are real. The legacy shell-era Living Force plist has now been retired, but the broader immune-system layer still spans multiple runtime and shared-skills components. |
