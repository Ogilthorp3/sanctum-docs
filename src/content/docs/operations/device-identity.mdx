...
This page used to say columbo "already pinned family phones via Bonjour." It
did not — not once, across 9,722 log lines. Phones are now pinned from the
Firewalla's always-on view instead;
[the full account](/operations/2026-08-09-everyone-says-theyre-alberts-iphone/)
explains why the old path could never have worked.
</Aside>
