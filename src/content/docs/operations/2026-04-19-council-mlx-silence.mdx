...
Roadmap updated with a new item: binary-file-integrity check as a first-class signal. The [Living Force](/architecture/living-force/) learns from sixteen hours of sleeping. Our reasoner had it exactly backwards: alive on the process table, answering with a green heartbeat, doing none of the work. A probe that never touches the work never sees the work fail.
