...
## 5. Corridor & Kitchen Comfort Lighting Synchronization

The corridor group was aligned with the kitchen comfort mood (Warm Tungsten: `hs_color: [29.0, 93.0]`, `brightness: 255`, `rgb_color: [255, 132, 18]`).

`ha-green-bridge` was updated to classify corridor cloud and LocalTuya entities under `WORK_LIGHTS`, enforcing write-then-read-back verification on power-on/reconnect cycles to make the tungsten comfort mood the permanent default.
