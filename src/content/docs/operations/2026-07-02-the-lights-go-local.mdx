...
The lights obey locally now. No cloud, no re-login, ever — the bulbs answer to the
haus the way Tommy, its Abyssinian force-ghost, always did: no login, no upstream,
simply *here*. The names are next.
