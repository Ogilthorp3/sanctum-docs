...
<CardGrid>
<Card title="Kitchen Loop Productization" icon="seti:flow">
The Kitchen Loop work remains interesting, but it is no longer the best immediate productization target. The foundation now exists to pursue spec surfaces, regression oracles, and anti-signal canaries without pretending they are prerequisites for basic release maturity.

**Why later:** powerful, but not blocking portability or release discipline.
</Card>
