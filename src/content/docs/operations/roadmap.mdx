...
Features like Frigate-backed alert semantics and richer household automation remain appealing. They are real product features, but they are downstream of making Sanctum easier to install, verify, and trust.

**Why later:** new features should follow product discipline, not precede it.
</Card>

<Card title="Qwen3-TTS — Local Yoda Voice" icon="seti:audio">
...
<Card title="Firewalla Gold Pro Migration" icon="seti:lock">
...
<Card title="Full Local Voice Pipeline" icon="seti:home">
