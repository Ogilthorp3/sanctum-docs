...
![Tommy at the drafting table — shipped features in ink, Phase 2 in deliberate pencil](../../../assets/illustrations/roadmap-blueprint-table.png)
...
<Card title="Operator Docs" icon="seti:book">
Write the docs a stranger would actually need after the architecture pages convince them to care. Installation, verification, upgrade, troubleshooting, rollback, and removal should read like operator guidance, not oral tradition.

**Deliverables:** install guide, verify guide, upgrade path, failure-mode playbooks.
</Card>
