...
description: Built-in scripts for monitoring, syncing, diagnosing, and maintaining your Sanctum instance. Your house has a CI/CD pipeline. Let that sink in.
---
...
<Aside type="caution">
The doctor reports but does not auto-fix keychain issues. Keychain surgery requires human hands. This is by design — automated keychain modification at 3 AM is how you end up locked out of your own house. The one with the AI agents. Think about that.
</Aside>
