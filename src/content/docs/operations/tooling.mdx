...
![Operations tooling — a workbench arrayed with small precision tools: tweezers, calipers, a torque wrench, a glowing teal multimeter probe.](./images/hero-tooling.png)
...
**What it checks:**
- Mac services: Cloudflare Tunnel, Home Assistant, `sanctum-mlx` + `sanctum-mlx-coder`, OrbStack
...
After generating, review the file, fill in any hardware-specific values (Lima VM instance name, Firewalla MAC address, HA entity IDs), then run `generate-plists.sh` to create the LaunchAgents.
