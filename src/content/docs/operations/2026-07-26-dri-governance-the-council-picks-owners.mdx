...
{/* TODO: hero — pencil sketch per CONTRIBUTING. Prompt: A round pencil-sketched council table where nine seats each raise a small standard and one chair sits conspicuously empty under a soft teal halo, Tommy the Abyssinian watching the gap. Out: ./images/hero-dri-governance-council-picks-owners.png */}
