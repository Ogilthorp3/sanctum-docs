...
When something that worked breaks after reboot, ask what **changed** between boots — [falsify before you fortify](/operations/2026-07-03-verify-before-you-fortify/) — and never let an optional seat (Heretic, a color-temp "guard," a pre-VM SSH) take down the required one.
