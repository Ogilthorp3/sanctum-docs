...
![Sanctum Gateway runbook — an operator's workbench with key rotation tool, debug magnifier on a 401 receipt, a backup-tape coil, a small wedged-door cartoon.](./images/hero-sanctum-gateway-runbook.png)
