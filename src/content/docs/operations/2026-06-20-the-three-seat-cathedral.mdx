...
the redundant 35B is gone. Somewhere on the terrace, Tommy would note that the
best guardian is the one you never have to feed twice — and go back to watching
the sun. The cathedral got bigger by getting simpler.
