...
![mTLS Migration — two cryptographic handshake diagrams converging on port 1337, mutual certificates etched into the frame, amber glow from the CA stamp.](./images/hero-mtls-migration.png)
